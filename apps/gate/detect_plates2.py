...
def check_parking_vacancy(frame, boxes, parking_spots):
    relevant_class_ids = [0]  # Indices corresponding to ["car", "van", "bus", "truck", "heavy truck", "motorcycle"]
...
def run_plate_detection(video_source: Union[str, int], model_path: str, parking_spots: list, stframe, show_boxes: bool, counter_display):
    ...
    frame_count = 0
    process_every_n_frames = 30  # Process every 5th frame, adjust as needed
